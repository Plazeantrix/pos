...
Public Class D_ShareTransaction
    Public Function GetTableDetails(TranNo As String, TranDate As String, Accountnumber As String, Amount As String) As DataTable
        ...
        Try
            ...
            strSQL = "SELECT TOP 1 * FROM ShareTransaction "
    ...
    Public Function SetDataTableToClass(clsObject As M_ShareTransaction, MyDataTable As DataTable) As String
        Try
            With clsObject
