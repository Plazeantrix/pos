Public Class M_TDTransaction
    ...
    Private _ParentTransactionNo As Long = 0
    ...
    Public Property ParentTransactionNo() As Long
        Get
            Return _ParentTransactionNo
        End Get
        Set(ByVal value As Long)
            _ParentTransactionNo = value
        End Set
    End Property
